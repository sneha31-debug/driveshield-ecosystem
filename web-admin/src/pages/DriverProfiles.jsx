...
const TREND_ARROW = { up: { arrow: '↑', cls: 'delta-up' }, down: { arrow: '↓', cls: 'delta-down' }, neu: { arrow: '→', cls: 'delta-neu' } };
                ...
                <div className="card driver-detail-header">
                    <div className="ddh-left">
                        ...
                        <div>
                            ...
                            <p className="ddh-id">{selected.id}</p>
                            <span className={`badge ${STATUS_CLS[selected.status]}`}>{selected.status.charAt(0).toUpperCase() + selected.status.slice(1)}</span>
                        </div>
                    </div>
